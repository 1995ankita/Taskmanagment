                                    ...
                                    <table class="table table-bordered" id="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Permissions</th> <!-- Add this column -->
                                        ...
                                        $(document).ready(function() {
                                            $('#table').DataTable({
                                                ...
                                                columns: [
                                                    ...
                                                    { data: 'permissions', name: 'permissions' }, // Display permissions
                                                    { // Actions column
                                                        data: 'id',
                                                        name: 'actions',
                                                        orderable: false,
                                                        ...
                                                        render: function(data, type, full, meta) {
                                                            var editUrl = '{{ route('files.edit', ':id') }}'.replace(':id', data);
                                                            var deleteFormId = 'delete-form-' + data;
                                                            var deleteUrl = '{{ route('files.destroy', ':id') }}'.replace(':id', data);
